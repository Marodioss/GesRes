...
<div class="clearfix"></div>
					...
					<ul class="nav nav-tabs custom-menu-wrap custon-tab-menu-style1">
						<li class="active"><a data-toggle="tab" href="#TabProject"
							aria-expanded="true"><span
								class="edu-icon edu-analytics tab-custon-ic"></span>Disponibiliter</a></li>
					</ul>
					<div id="TabDetails"
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<h4>Formulaire</h4>
									<hr>
									<%@include file="forms/gestion/planning.jsp"%>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<h4>Liste</h4>
									<hr>
									<div class="product-status-wrap drp-lst" style="padding: 0;">
										<div class="asset-inner">
											<%@include file="forms/listes/planning.jsp"%>
										</div>
									</div>
								</div>
							</div>
 ...
 <!-- simplebar js -->
  ...
  <script src="assets/js/index.js"></script>
	...
	<script src="js/plugins.js"></script>
	<script src="js/main.js"></script>
	<script src="script/planning.js"></script>
	<script src="js/tawk-chat.js"></script>
</body>
</html>
</c:when>
